    ...
    <div class="container">
        <div class="property-details-card">
            <?php if (isset($property)): ?>
                ...
                <p class="text-center"><strong>Price:</strong> RM<?php echo htmlspecialchars(number_format($property['price'], 2)); ?></p>
                <hr>
                ...
                <div class="d-flex justify-content-between">
                    <a href="available_properties.php" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back to Properties</a>
                    <a href="submit_appointment.php?id=<?php echo $property_id; ?>" class="btn btn-custom"><i class="fas fa-calendar-check"></i> Submit Appointment</a>
                </div>
            <?php else: ?>
